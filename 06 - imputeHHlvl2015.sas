...
/* using IMPUTED_FINAL_2015 datasets with SIZE_NEW, SIZE_IMPUTED_MEAN, SIZE_IMPUTED_MEDIAN, SIZE_IMPUTED_MODE */
/* load back into SAS our permanent copy */
DATA imputed_final_2015;
SET cfoy.imputed_final_2015;
RUN;
...
PROC SQL;
CREATE TABLE totalsperHH2015 AS
