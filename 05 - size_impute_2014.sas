...
/* final_2014 and calculated statistics table (mean, median, mode) */
...
DATA merged;
	MERGE final_2014 rulesapplied_2014;
	BY Food_Group_Code_1 Food_Group_Code_2 Food_Group_Code_3;
RUN;
