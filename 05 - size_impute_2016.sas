...
/* final_2016 and calculated statistics table (mean, median, mode) */
...
DATA merged;
	MERGE final_2016 rulesapplied_2016;
	BY Food_Group_Code_1 Food_Group_Code_2 Food_Group_Code_3;
RUN;
