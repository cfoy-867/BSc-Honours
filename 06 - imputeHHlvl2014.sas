...
/* using IMPUTED_FINAL_2014 datasets with SIZE_NEW, SIZE_IMPUTED_MEAN, SIZE_IMPUTED_MEDIAN, SIZE_IMPUTED_MODE */
/* load back into SAS our permanent copy */
DATA imputed_final_2014;
SET cfoy.imputed_final_2014;
RUN;

/* level of processing */
/* LOP - expenditure, and weights (size new, mean, median and mode) */
DATA imputed_final_2014;
SET imputed_final_2014;
...
/* permanent file */
DATA cfoy.imputed_final_2014;
SET imputed_final_2014;
RUN;

/* Total expenditure and total purchased weight for each HH */
PROC SQL;
CREATE TABLE totalsperHH2014 AS
